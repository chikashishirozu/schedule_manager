                    ...
                    <div class="card-body" style="background-color: #e6e6fa;">
                        <form action="{{ route('schedules.update', $schedule->id) }}" method="POST">
                            ...
                            <div class="mb-3" style="background-color: #e6e6fa;">
                                ...
                                <input type="datetime-local" class="form-control" style="background-color: #f0f8ff;" name="start_time" value="{{ old('start_time', \Carbon\Carbon::parse($schedule->start_time)->format('Y-m-d\TH:i')) }}"
     required>
                            </div>
    
                            <div class="mb-3" style="background-color: #e6e6fa;">
                                <label for="end_time" class="form-label">{{ __('終了時間:') }}</label>
                                <input type="datetime-local" class="form-control" style="background-color: #f0f8ff;" name="end_time" value="{{ old('end_time', \Carbon\Carbon::parse($schedule->end_time)->format('Y-m-d\TH:i')) }}"
     required>
                            </div>
                    ...
                    <div class="card-body" style="background-color: #e6e6fa;">                    
                    <!-- div class="d-flex justify-content-between mt-3" style="background-color: #e6e6fa;" -->
                        <!-- 削除ボタン -->
